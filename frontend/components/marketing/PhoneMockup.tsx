...
const messages = [
  { id: 1, type: 'received', text: 'Can you share the course pricing?', delay: 1200 },
  { id: 2, type: 'sent', text: 'Absolutely. I have shared the current plans and next steps below.', isLinkCard: true, delay: 3000 },
  { id: 3, type: 'received', text: 'That was fast. Thanks for the quick reply.', delay: 6000 },
  { id: 4, type: 'sent', text: 'You are welcome. AutoFlow keeps comment-to-DM replies running around the clock.', delay: 7800 },
];
                ...
                >
                  ...
                  {msg.isLinkCard && (
                    <div className="mt-2.5 bg-[#121212] border border-[rgba(255,255,255,0.08)] rounded-xl p-2.5 text-[10px] leading-snug text-left select-none">
                      ...
                      <div className="text-[#606060] text-[8.5px] mt-0.5 font-light">Free plan: 500 DMs per month</div>
                    </div>
                  )}
